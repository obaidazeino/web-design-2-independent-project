...
const Navigation = () => {
    ...
    return (
        <div>
            ...
            <svg onClick={handleOpen} className="nav-icon hamburger" xmlns="http://www.w3.org/2000/svg" width="32" height="24" viewBox="0 0 32 24"><g id="Layer_2" data-name="Layer 2"><g id="hamburger"><rect width="32" height="4" fill="#30bf97"/><rect y="10" width="32" height="4" fill="#30bf97"/><rect y="20" width="32" height="4" fill="#30bf97"/></g></g></svg> */}
           <svg onClick={handleOpen} className="nav-icon hamburger" id="Layer_2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 24"><defs></defs><g id="hamburger"><g><rect class="cls-1" width="32" height="4"/><rect class="cls-1" x="9" y="10" width="23" height="4"/><rect class="cls-1" y="20" width="32" height="4"/></g></g></svg>
