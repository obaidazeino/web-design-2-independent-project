        ...
        content: [
            {
                ...
                extended: [
                    ...
                    "This “Artist” does not put out fires, teach children or treat the sick, because art and civic duty are tough to blend. A man who dips his toes into paradise as he watches the shades of blue displace each other in the morning sky, who finds his warmth in symmetry and thrill in imagination, who watches a majestic waterfall and a wary ant with equal awe, and quietly sips the lemonade of dusk to end his day… a man who lives life for its own sake, the way we all ought to but don’t, understands that oriented pursuits are missing the point and harshly speaking over the gentle hum of art unaware.  That being said, This artist gets to make one  exception in blind faith, and that is to raise his torch of art as bright as can be in the hope that someone will get a sliver of his own experience or perhaps find a torch of his own and raise it."
                ]
            },
            {
                id: "2",
                ...
                extended: [
                    // "Does anyone else believe that the portrayal of depression in today’s society as a purely biological illness to which the only effective form of action is pharmaceutical, is counterproductive and misleading at best?", 
                    // "I think this issue is extremely pressing today and needs to be addressed more honestly. As someone who’s had a comprehensive taste of the burning hell of depression for a few months and have gotten out of it stronger than ever without submitting to the narrative of the biological ilnesss to which the patient is a passive victim, I believe depression is your body telling you there is something deeply wrong going on in your life or your thought patterns and outlook on life (isnt that all that matters anyways?). It’s impossible to pin down one cause but I do believe that even if the cause goes way back in your psychological history or involves complex trauma you may or may not be particularly conscious of, there is an answer and a way forward as soon as you acknowledge your problem and strive for constructive change, resolution of life probelms, and therapy of your psyche with plenty of psychological assistance available today. However, it can definitely be the case that the depressed person is paralyzed to the point of dysfunctionality and maybe antidepressants can help jump start a positive change but their intake should be temporary in the majority of cases and the goal should involve more psychological therapy and recovery and as little and brief dependence on pharmaceuticals as possible.",
                    // "The fact that your psychological state can influence and perpetuate pathlogological brain chemistry is no rationale for the conclusion that the depressed person is a passive victim, if anything it’s a source of hope that healthier thought patters and resolution of life probelms can have an equally corrective influence on your brain chemistry.",
